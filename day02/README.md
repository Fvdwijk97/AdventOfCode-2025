...
An ID is invalid if it only consists of two identical sequence of digits.
Examples: 
...
The rules expand:
An ID is invalid if it is made entirely of a smaller repeating pattern, repeated two or more times.
Examples:
